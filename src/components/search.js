...
export default function SearchAppBar(props) {
  ...
  const handleClearFilters = () => {
    ...
    setCity("");
    setState("");
    // Call the respective change functions with empty values to clear the filters
    onRentChange("");
    onPriceChange("");
    onCityChange("");
    onStateChange("");
  ...
  const uniqueRentValues = [
    ...new Set(newProperty.map((property) => property.status)),
  ];
  const uniquePriceValues = [
    ...new Set(newProperty.map((property) => property.price)),
  ];
  const uniqueCityValues = [
    ...new Set(newProperty.map((property) => property.city)),
  ];
  const uniqueStateValues = [
    ...new Set(newProperty.map((property) => property.state)),
  ];
